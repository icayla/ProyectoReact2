...
const ProductosDestacados = (props) => {
 ...
 <div className='grid grid-cols-1 flex-col lg:flex-row mx-10 '>
  <figure className='productos  rounded-2x1 bg-gradient-to-r from-slate-200 via-gray-300 to-stone-400 p-1 shadow-xl'>
   <div className="flex-none w-auto shadow-lg rounded-md overflow-hidden">
   <a href='#' className='block group'>
   <img src= {props.objeto.urlimg} title= "lentes" className='h-full w-full object-cover rounded-x1' ></img>
   </a> </div>
         ...
         <figcaption>
          ...
          <span className="w-full flex-none mt-2 order-1 text-2x1 font-bold text-green-700">
            En stock
          </span>
